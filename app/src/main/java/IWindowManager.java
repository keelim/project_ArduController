...
public interface IWindowManager extends android.os.IInterface
{
  ...
  public static class Default implements IWindowManager
  {
    ...
    /**
         ...
         */
    @Override public boolean isLayerTracing() throws android.os.RemoteException
    {
      return false;
    }
    /**
         ...
         */
    @Override public void setLayerTracing(boolean enabled) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.view.IWindowManager
  {
    ...
    public static java.lang.String getDefaultTransactionName(int transactionCode)
    {
      switch (transactionCode)
      {
        ...
        case TRANSACTION_isLayerTracing:
        {
          return "isLayerTracing";
        }
        case TRANSACTION_setLayerTracing:
        {
    ...
    private static class Proxy implements android.view.IWindowManager
    {
      ...
      @Override public boolean isLayerTracing() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_isLayerTracing, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().isLayerTracing();
          }
          _reply.readException();
          _result = (0!=_reply.readInt());
        }
      ...
      @Override public void setLayerTracing(boolean enabled) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(((enabled)?(1):(0)));
          boolean _status = mRemote.transact(Stub.TRANSACTION_setLayerTracing, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().setLayerTracing(enabled);
            return;
          }
          _reply.readException();
        }
    ...
    static final int TRANSACTION_isLayerTracing = (android.os.IBinder.FIRST_CALL_TRANSACTION + 102);
    static final int TRANSACTION_setLayerTracing = (android.os.IBinder.FIRST_CALL_TRANSACTION + 103);
  ...
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:78:1:78:25")
  public void getInitialDisplaySize(int displayId, android.graphics.Point size) throws android.os.RemoteException;
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:80:1:80:25")
  ...
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:84:1:84:25")
  ...
  /**
       ...
       * time, so we want to move that off the critical path for starting the new activity.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:104:1:104:25")
  ...
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:108:1:108:25")
  ...
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:111:1:111:25")
  public void executeAppTransition() throws android.os.RemoteException;
  /**
        * Used by system ui to report that recents has shown itself.
        * @deprecated to be removed once prebuilts are updated
        */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:118:1:118:25")
  ...
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:130:1:130:25")
  public boolean isKeyguardLocked() throws android.os.RemoteException;
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:132:1:132:25")
  ...
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:142:1:142:25")
  public float getAnimationScale(int which) throws android.os.RemoteException;
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:144:1:144:25")
  public float[] getAnimationScales() throws android.os.RemoteException;
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:146:1:146:25")
  public void setAnimationScale(int which, float scale) throws android.os.RemoteException;
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:148:1:148:25")
  ...
  @android.compat.annotation.UnsupportedAppUsage(maxTargetSdk = 28, overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:154:1:154:44")
  ...
  @android.compat.annotation.UnsupportedAppUsage(maxTargetSdk = 28, overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:162:1:162:44")
  ...
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:169:1:169:25")
  ...
  /**
       ...
       * @hide
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:208:1:208:25")
  ...
  /**
       ...
       * android.view.Display#DEFAULT_DISPLAY} and given rotation.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:224:1:224:25")
  public void freezeRotation(int rotation) throws android.os.RemoteException;
  /**
       * Equivalent to calling {@link #thawDisplayRotation(int)} with {@link
       * android.view.Display#DEFAULT_DISPLAY}.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:231:1:231:25")
  ...
  /**
       * Called by System UI to notify of changes to the visibility and height of the shelf.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:331:1:331:25")
  public void setShelfHeight(boolean visible, int shelfHeight) throws android.os.RemoteException;
  /**
       * Called by System UI to enable or disable haptic feedback on the navigation bar buttons.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:337:1:337:25")
  ...
  /**
       ...
       * @param displayId the id of display to check if there is a software navigation bar.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:345:1:345:25")
  ...
  /**
       * Lock the device immediately with the specified options (can be null).
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:356:1:356:25")
  public void lockNow(android.os.Bundle options) throws android.os.RemoteException;
  /**
       * Device is in safe mode.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:362:1:362:25")
  ...
  /**
       ...
       *         WindowManagerGlobal.DOCKED_* values
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:390:1:390:25")
  ...
  /**
       ...
       * the docked stack gets added/removed.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:403:1:403:25")
  ...
  /**
       * Retrieves the current stable insets from the primary display.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:430:1:430:25")
  ...
  /**
       * Create an input consumer by name and display id.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:453:1:453:25")
  ...
  /**
       ...
       * This method will also dispose the input channels associated with that InputConsumer.
       */
  @android.compat.annotation.UnsupportedAppUsage(overrideSourcePosition="frameworks/base/core/java/android/view/IWindowManager.aidl:461:1:461:25")
  ...
  /**
       * Enables/disables SurfaceFlinger layer tracing.
       */
  public void setLayerTracing(boolean enabled) throws android.os.RemoteException;
}