...
class FlashFragment : Fragment(R.layout.activity_flash) {
...
//        * First check if device is supporting flashlight or not
    ...
    private fun playSound() {
        mediaPlayer = if (isFlashOn) {
            MediaPlayer.create(this@FlashFragment, R.raw.light_switch_off)
        } else {
            MediaPlayer.create(this@FlashFragment, R.raw.light_switch_on)
        }.apply {
