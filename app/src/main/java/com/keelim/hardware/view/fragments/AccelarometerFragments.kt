...
class AccelarometerFragments : Fragment(R.layout.activity_accelarometer), SensorEventListener {
    ...
    override fun onCreateView(
        ...
        sensmgr = requireContext().getSystemService(Context.SENSOR_SERVICE) as SensorManager
